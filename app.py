...
with tab_data:
    ...
    st.markdown(
        "Use **one Excel workbook** containing exactly these three worksheets: "
    ...
    if os.path.exists(template_path):
        ...
        st.download_button(
            ...
            help="Downloads a single workbook with Demand, Generators, and SpotMarket worksheets."
        )

    st.markdown("### Upload Consolidated Excel Workbook")
